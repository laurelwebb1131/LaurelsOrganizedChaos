...
6. Set `HEARTHWISE_ALLOWED_ORIGINS` to a comma-separated allowlist in production.
7. Never put provider credentials in `VITE_*` variables, the Tauri bundle, git, or client-visible responses.
